  ...
  <html>
    <head>  
       ...
       <title> Clinica Médica - Neurologia </title>
        ...
        <div id="god" class="white"> 
            <div id="SobreNos" class="row">
                ...
                <div class="col s12 offset-s2">
                    <br>
                    <h4 class="white-text"> Neurologia </h4>
                    <br>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col s12 m6 l6">
                        <img class="responsive-img" src="Img_Prog/neurologia.jpg" style="height: 419px; width: 396px;">
                    </div>
                    <div class="col s12 m6 l6">
