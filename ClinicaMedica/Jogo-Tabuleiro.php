...
<html lang="pt-br">
  ...
  <body>
        ...
        <div id="tabuleiro">
            <img src="Img_Prog/tabuleiro/tabuleiro.png" usemap="#mapaTabuleiro">
        ...
        <map name="mapaTabuleiro">
            ...
            <area title="23" shape="rect" coords="2132,121,2364,361" onclick="alertaTeste()"/>
