<!DOCTYPE html>
  <html>
    <head>  
       ...
       <title> Clinica Médica - Cardiologia </title>
        ...
        <div id="god" class="white">
            ...
            ?>
                ...
                <div class="col s8 offset-s2">
                    <br>
                    <h4 class="white-text center"> Cardiologia </h4>
                    <br>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col s12 m6 l6">
                        <img class="responsive-img" src="Img_Prog/cardiologia.jpg" style="height: 419px; width: 396px;">
                    </div>
                    <div class="col s12 m6 l6">
                        <h4 class="corVerdeTexto center"> A especialidade </h4>
                        <p class="topicos"> 
